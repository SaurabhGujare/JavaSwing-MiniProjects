...
public class ManageProdPanel extends javax.swing.JPanel {
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        ...
        if(selectedRow<0){
            ...
            ViewPanel viewPanel= new ViewPanel(rightPanel, product);//show only detail of one product
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(result==null){
            ...
            ViewPanel viewPanel= new ViewPanel(rightPanel, result);//show only detail of one product
            rightPanel.add("ViewPanel", viewPanel);
            CardLayout layout=(CardLayout)rightPanel.getLayout();
            layout.next(rightPanel);
        }
